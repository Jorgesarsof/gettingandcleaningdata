...
## Organizing and combining raw data sets 
...
## Creates a second, independent tidy data set with the average of each variable for each activity and each subjetct
names(singleDataSet)
